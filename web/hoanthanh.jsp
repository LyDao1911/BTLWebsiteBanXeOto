<%-- 
    Document   : hoanthanh
    Created on : Oct 22, 2025, 10:04:27 PM
    Author     : Admin
--%>
    ...
    <body>
        ...
        <div class="order-page">
            ...
            <div class="tabs">
                ...
                <a href="chuathanhtoan.jsp" class="tab">CHƯA THANH TOÁN</a>
                <a href="hoanthanh.jsp" class="tab active">HOÀN THÀNH</a>
            </div>
            ...
            <div class="brand-section">
                ...
                <div class="brand-footer">
                    ...
                    <button class="btn-success" onclick="location.href = 'dathang.jsp'">MUA LẠI</button>
                    <button class="btn-success" onclick="location.href = 'hoadon.jsp'">XEM HÓA ĐƠN</button>
                </div>
            </div>
        </div>
        <!-- FOOTER -->
